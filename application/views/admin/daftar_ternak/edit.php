<div class="box col-md-9">
	...
	<div class="box-body">
		...
		?>
		<?php echo form_open_multipart('admin/daftar_ternak/edit/' . $daftar_ternak['daftar_ternak_id']); ?>
<div class="col-sm-12">
			...
			<div class="form-group">
				...
				<input type="inisial_ternak" name="inisial_ternak" class="form-control" value="<?php echo $daftar_ternak['inisial_ternak']; ?>" placeholder="Inisial Ternak" required="">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="ras_ternak" class="form-control" value="<?php echo $daftar_ternak['ras_ternak']; ?>" placeholder="Ras Ternak" required="">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="umur_ternak" class="form-control" value="<?php echo $daftar_ternak['umur_ternak']; ?>" placeholder="Umur Ternak" required="">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="pemilik_ternak" class="form-control" value="<?php echo $daftar_ternak['pemilik_ternak']; ?>" placeholder="Pemilik Ternak" required="">
			</div>
			<div class="form-group">
				<label for="nama_peternakan">Peternakan</label>
				<input type="text" name="nama_peternakan" class="form-control" value="<?php echo $daftar_ternak['nama_peternakan']; ?>" placeholder="Peternakan" required="">
			</div>
			<div class="form-group">
		...
		<div class="col-sm-12">
			<div class="form-group pull-right">
				<a href="<?php echo base_url('admin/daftar_ternak/daftar_ternak_list/'.$daftar_ternak['pasar_ternak_id']); ?>" class="btn btn-default"><i class="fa fa-undo"></i> Kembali</a>
