	<div class="box-body col-md-9">
		...
		<?php echo form_open_multipart('admin/users/tambah_peternakan');	?>
		<div class="col-sm-9">
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<input type="text" name="nama_peternakan" class="form-control" value="<?php echo set_value('nama_peternakan'); ?>" placeholder="Nama Peternakan" >
				</div>
				<div class="form-group">
				...
				<input type="hidden" name="akses_level" value="Peternak">
			</div>
			<div class="form-group">
				<label for="akses_level"></label>
			...
			<div class="col-md-12">
				<div class="form-group pull-right">
					<a href="<?php echo base_url('admin/users/daftar_operator_pasar_ternak/'.$users['pasar_ternak_id']); ?>" class="btn btn-default"><i class="fa fa-undo"></i> Kembali</a>
