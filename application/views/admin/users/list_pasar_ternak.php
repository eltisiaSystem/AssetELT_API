          ...
          <?php $no=1; foreach($users as $users){ ?>
            <tr>
              ...
              <td style="text-align: center">
                <a href="<?php echo base_url('admin/users/daftar_operator_pasar_ternak/'.$users['pasar_ternak_id']) ?>" class="btn btn-warning"><i class="fa fa-eye"></i>Operator</a>

                <?php if($akses_level === "Admin"){ ?> 
                <a href="<?php echo base_url('admin/users/edit_pasar_ternak/'.$users['user_id']) ?>" class="btn btn-info"><i class="fa fa-edit"></i>Edit 
                </a>
