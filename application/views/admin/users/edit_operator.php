	<div class="box-body" col-md-9>
		...
		?>
		<?php echo form_open_multipart('admin/users/edit_operator_pasar_ternak/' . $users['user_id']); ?>
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<input type="hidden" name="akses_level" value="Operator">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="operator_id"></label>
				<input type="hidden" name="operator_id" value="<?php echo $users['pasar_ternak_id']; ?>">
			</div>
		</div>
		<div class="col-sm-12">
